...
function(_melo_link src dst)
    ...
    get_property(_melo_told GLOBAL PROPERTY MELO_COPY_FALLBACK_TOLD)
    if(NOT _melo_told)
        message(STATUS "melo: symlinks unavailable, copying the plugin import dir")
        set_property(GLOBAL PROPERTY MELO_COPY_FALLBACK_TOLD TRUE)
    endif()
    if(IS_DIRECTORY "${src}")
        file(MAKE_DIRECTORY "${dst}")
        # the copies are ours: no read-only bit carried over from the Qt install
